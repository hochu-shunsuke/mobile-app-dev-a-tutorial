...
import jp.ac.meijou.android.s241205155.databinding.ActivityMain7Binding;
...
public class MainActivity7 extends AppCompatActivity {
    ...
    private void updateTransport(Network network) {
        ...
        if (caps != null) {
            ...
            binding.main7Transport.setText(transport);
        }
    }
    ...
    private void updateIpAddress(Network network) {
        ...
        if (linkProperties != null) {
            ...
            binding.main7Ipaddress.setText(addresses);
        }
    }
